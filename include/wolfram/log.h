...
#define WF_LOG_DEBUG(module, ...)                                              \
    wf_log(WF_LOG_LEVEL_DEBUG, module, __VA_ARGS__)
...
#define WF_LOG_ERROR(module, ...)                                              \
    wf_log(WF_LOG_LEVEL_ERROR, module, __VA_ARGS__)
