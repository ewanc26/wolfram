 ...
 *                        Example:
 * '[{"$type":"app.bsky.feed.postgate#disableRule"}]' detached_uris        —
 * array of AT-URI strings to detach, or NULL. detached_count       — number of
 * detached-URI entries. out                  — receives the created record's
 * URI and CID.
 */
