 ...
 *
  * The DID is `did:plc:<base32(sha256(canonical-cbor(operation)))[:24]>`,
  * derived from the canonical DAG-CBOR encoding of the operation data with
  * the `sig` field omitted. The input JSON is parsed internally; the caller
