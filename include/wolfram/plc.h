 ...
 *
 * The DID is `did:plc:<base32(sha256(canonical-cbor(signed-op)))[:24]>`,
 * derived from the canonical DAG-CBOR encoding of the signed operation
 * (including `sig`). The input JSON is parsed internally; the caller frees
